...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.TelegramConnector;
 ...
 */
public class TelegramBotConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "TelegramConnector test case")
